...
import { ArrowLeftIcon, Code2Icon, GlobeIcon, Loader2Icon } from 'lucide-react'
  ...
  return (
    <header className='h-12 shrink-0 flex items-center justify-between px-3 border-b border-zinc-200 bg-white'>
        <div className='flex items-center gap-2'>
            <button onClick={onBack} className='p-1.5 rounded-md text-zinc-400 hover:text-zinc-950 
        ...
        <div className='flex items-center gap-1.5'>
            <button onClick={onToggleShowCode}
             className={`inline-flex items-center justify-center gap-1.5 py-1.5 px-3
             border-zinc-200 text-zinc-600 hover:bg-zinc-900 text-xs
